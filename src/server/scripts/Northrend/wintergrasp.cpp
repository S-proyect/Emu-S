...
#define GOSSIP_HELLO_DEMO1  "Costruir Catapulta."
#define GOSSIP_HELLO_DEMO2  "Costruir Demoledor."
#define GOSSIP_HELLO_DEMO3  "Construir máquinas de asedio."
#define GOSSIP_HELLO_DEMO4  "No se puede construir más!"
