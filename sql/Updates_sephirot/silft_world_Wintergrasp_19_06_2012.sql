...
('756', 'Comienza la Batalla!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '??????? ??????????'),
('757', '%s ha defendido con éxito la fortaleza!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '%s ??????? ?????????(?) ???????????!'),
('758', '%s se ha hecho cargo de la fortaleza!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '%s ??????????(?) ???????????'),
('759', 'El taller de asedio %s ha sido dañado por el %s!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
/* Wintergrasp Battle-Mage hay que revisar su ubicacion*/
